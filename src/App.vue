  ...
  <v-app>
    ...
    <v-navigation-drawer v-model="drawer" absolute temporary>
      <v-list nav dense>
        ...
        >
          <v-list-item>
            <v-list-item-title>ok</v-list-item-title>
          </v-list-item>

          <v-list-item>
            <v-list-item-title>shhhh</v-list-item-title>
          </v-list-item>

          <v-list-item>
            <v-list-item-title>ok1</v-list-item-title>
          </v-list-item>

          <v-list-item>
            <v-list-item-title>ok2</v-list-item-title>
          </v-list-item>
        </v-list-item-group>
      </v-list>
    </v-navigation-drawer>
